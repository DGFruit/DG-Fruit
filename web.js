...
document.addEventListener("click", (e) => {
    ...
    if (helpTrigger) {
        ...
        window.location.href = isSubfolder ? `../Secret/secretindex.html` : `Secret/secretindex.html`;
    }
...
setupNav("home-btn", "index.html");
setupNav("mobile-home-btn", "index.html");
setupNav("showcases-btn", "showcases.html");
setupNav("dropdown-showcases-btn", "showcases.html");
setupNav("learning-btn", "Learning/learningindex.html");
setupNav("dropdown-learning-btn", "Learning/learningindex.html");
setupNav("ai-btn", "Secret/secretindex.html");
setupNav("mobile-ai-btn", "Secret/secretindex.html");
setupNav("secret-hub-button", "Secret/secretindex.html");
